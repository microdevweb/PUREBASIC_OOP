...
Interface Demo_MainViewModel_vt Extends MVVM_ViewModelBase_vt
  OnIncrement()
  OnReset()
EndInterface
...
Structure Demo_MainViewModel_Inst Extends MVVM_ViewModelBase_Inst
  clickCount.i
EndStructure
...
Declare.i UI_CanvasText_GetHorizontalAlignment(*This.UI_CanvasText_Inst)
Declare.i UI_CanvasText_GetVerticalAlignment(*This.UI_CanvasText_Inst)
...
Declare Demo_MainViewModel_Init(*This.Demo_MainViewModel_Inst)
Declare Demo_MainViewModel_OnIncrement(*This.Demo_MainViewModel_Inst)
Declare Demo_MainViewModel_OnReset(*This.Demo_MainViewModel_Inst)
Declare.b Demo_MainViewModel_OnCommand(*This.Demo_MainViewModel_Inst, name_p.s, *param)
...
Declare.i New_Demo_MainViewModel()
Declare Free_Demo_MainViewModel(*obj.Demo_MainViewModel_Inst)
  ...
  Protected *This_vt.UI_CanvasButton_vt = *This
        ...
        *This_vt\DrawFocusRing(w_p, h_p)
        ...
        If *This\text <> ""
          ...
          DrawText(startX, txtY, *This\text, fg, *This_vt\GetCurrentBackgroundColor())
        EndIf
EndProcedure
...
Procedure.i UI_CanvasText_GetHorizontalAlignment(*This.UI_CanvasText_Inst)
  Protected *This_vt.UI_CanvasText_vt = *This
        ProcedureReturn *This\hAlign
EndProcedure

Procedure.i UI_CanvasText_GetVerticalAlignment(*This.UI_CanvasText_Inst)
  Protected *This_vt.UI_CanvasText_vt = *This
...
Procedure Demo_MainViewModel_Init(*This.Demo_MainViewModel_Inst)
  Protected *This_vt.Demo_MainViewModel_vt = *This
        MVVM_ViewModelBase_Init(*This)
        *This\clickCount = 0
  
        *This_vt\SetString("StatusText", "Survolez ou cliquez sur les boutons, ou tapez dans le champ de texte")
        *This_vt\SetString("ClickMessage", "Clics : 0")
        *This_vt\SetBool("IsHovered", #False)
        *This_vt\SetString("UserName", "microdev")
        *This_vt\SetString("UserGreeting", "Bonjour microdev ! (Saisie en direct MVVM)")
  
        ; Enregistrement d'un observer pour surveiller les proprietes en live
        *This_vt\RegisterObserver(*This, @Demo_OnVMPropChanged())
EndProcedure

Procedure Demo_MainViewModel_OnIncrement(*This.Demo_MainViewModel_Inst)
  Protected *This_vt.Demo_MainViewModel_vt = *This
        *This\clickCount + 1
        *This_vt\SetString("ClickMessage", "Clics : " + Str(*This\clickCount))
        *This_vt\SetString("StatusText", "Commande 'IncrementClick' recue ! (Total: " + Str(*This\clickCount) + ")")
EndProcedure

Procedure Demo_MainViewModel_OnReset(*This.Demo_MainViewModel_Inst)
  Protected *This_vt.Demo_MainViewModel_vt = *This
        *This\clickCount = 0
        *This_vt\SetString("ClickMessage", "Clics : 0")
        *This_vt\SetString("StatusText", "Compteur reinitialise a zero !")
EndProcedure

Procedure.b Demo_MainViewModel_OnCommand(*This.Demo_MainViewModel_Inst, name_p.s, *param)
  Protected *This_vt.Demo_MainViewModel_vt = *This
        Select (LCase(name_p))
          Case "incrementclick":
            *This_vt\OnIncrement()
...
DataSection
  ...
  UI_CanvasText_VTable_Data:
    ...
    Data.i @UI_Component_GetMarginBottom()
    Data.i @UI_Component_SetHorizontalAlignment()
    Data.i @UI_CanvasText_GetHorizontalAlignment()
    Data.i @UI_Component_SetVerticalAlignment()
    Data.i @UI_CanvasText_GetVerticalAlignment()
    Data.i @UI_Component_SetMinWidth()
    Data.i @UI_Component_GetMinWidth()
    Data.i @UI_Component_SetMaxWidth()
    Data.i @UI_Component_GetMaxWidth()
  ...
  Demo_MainViewModel_VTable_Data:
    Data.i @MVVM_ViewModelBase_Free()
    Data.i @MVVM_ObservableObject_RegisterObserver()
    Data.i @MVVM_ObservableObject_UnregisterObserver()
    Data.i @MVVM_ObservableObject_NotifyPropertyChanged()
    ...
    Data.i @MVVM_ViewModelBase_RegisterBool()
    Data.i @MVVM_ViewModelBase_RegisterDouble()
    Data.i @Demo_MainViewModel_OnCommand()
    Data.i @Demo_MainViewModel_OnIncrement()
    Data.i @Demo_MainViewModel_OnReset()
EndDataSection
...
Procedure.i New_Demo_MainViewModel()
  Protected *obj.Demo_MainViewModel_Inst = AllocateStructure(Demo_MainViewModel_Inst)
  If *obj
    *obj\VTable = ?Demo_MainViewModel_VTable_Data
    Demo_MainViewModel_Init(*obj)
  EndIf
  ProcedureReturn *obj
EndProcedure

Procedure Free_Demo_MainViewModel(*obj.Demo_MainViewModel_Inst)
  If *obj
    MVVM_ViewModelBase_Free(*obj)
    FreeStructure(*obj)
  EndIf
...
; Demonstrating:
;   - UI_CanvasButton with Vector Rounded rendering and WPF Visual States
;   - UI_CanvasText with High-DPI typography & alignments
;   - UI_CanvasTextBox with caret, selection, focus ring & Two-Way Text binding
...
Procedure Demo_OnVMPropChanged(*vm.Demo_MainViewModel_vt, *pKeyPtr)
  If Not *pKeyPtr : ProcedureReturn : EndIf
...
Procedure RunApp()
  ...
  Protected *win.UI_Window_vt = New_UI_Window_s_i_i_i_i_i("WPF / WinUI CanvasControl & MVVM Architecture", 100, 100, 740, 580, #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
  *win\SetBackgroundColor(RGB(248, 249, 250))

  ; ViewModel
  Protected *vm.Demo_MainViewModel_vt = New_Demo_MainViewModel()
  *win\SetDataContext(*vm)

  ; Root Container : StackPanel vertical
  Protected *rootStack.UI_Layouts_StackPanel_vt = New_UI_Layouts_StackPanel_i(#UI_Orientation_Vertical)
  *rootStack\SetMargin(20, 20, 20, 20)

  ; 1. Header Title
  Protected *titleText.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("WPF-Style CanvasControl & MVVM Engine", 700, 36)
  ...
  *rootStack\AddChild(*titleText)
  ...
  ; 2. Subtitle
  Protected *subText.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("Composants vectoriels haute-performance, machine d'etats visuels et Two-Way Binding MVVM.", 700, 24)
  ...
  *rootStack\AddChild(*subText)
  ...
  ; 3. Separator spacing
  Protected *spacer1.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("", 700, 10)
  *rootStack\AddChild(*spacer1)

  ; 4. Live Status Banner (CanvasText avec bordure et fond dynamique)
  Protected *bannerText.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("", 700, 42)
  ...
  *rootStack\AddChild(*bannerText)
  ...
  ; 5. Separator spacing
  Protected *spacer2.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("", 700, 14)
  *rootStack\AddChild(*spacer2)

  ; 6. Section Saisie de Texte Vectorielle (CanvasTextBox avec Two-Way Binding)
  Protected *tbSectionTitle.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("Saisie Vectorielle & MVVM Two-Way Binding :", 700, 24)
  ...
  *rootStack\AddChild(*tbSectionTitle)
  ...
  Protected *tbRow.UI_Layouts_StackPanel_vt = New_UI_Layouts_StackPanel_i(#UI_Orientation_Horizontal)
  *tbRow\SetMargin(0, 0, 0, 12)

  Protected *txtInput.UI_CanvasTextBox_vt = New_UI_CanvasTextBox_s_i_i("Entrez un nom...", 320, 36)
  ...
  *tbRow\AddChild(*txtInput)
  ...
  Protected *greetingText.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("", 360, 36)
  ...
  *rootStack\AddChild(*tbRow)
  ...
  ; 7. Separator spacing
  Protected *spacer3.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("", 700, 14)
  *rootStack\AddChild(*spacer3)

  ; 8. Action Buttons Container
  Protected *buttonBar.UI_Layouts_StackPanel_vt = New_UI_Layouts_StackPanel_i(#UI_Orientation_Horizontal)
  *buttonBar\SetMargin(0, 0, 0, 16)

  ; Bouton 1 : Primary avec Style WPF, Commande MVVM et Two-Way Hover Binding
  Protected *btnPrimary.UI_CanvasButton_vt = New_UI_CanvasButton_s_i_i("Clic +1 (Primary)", 180, 38)
  ...
  *buttonBar\AddChild(*btnPrimary)
  ...
  Protected *btnReset.UI_CanvasButton_vt = New_UI_CanvasButton_s_i_i("Reset Compteur", 150, 38)
  ...
  *buttonBar\AddChild(*btnReset)
  ...
  Protected *btnPill.UI_CanvasButton_vt = New_UI_CanvasButton_s_i_i("Style Pilule", 120, 38)
  ...
  *rootStack\AddChild(*buttonBar)
  ...
  Protected *counterDisplay.UI_CanvasText_vt = New_UI_CanvasText_s_i_i("Clics : 0", 700, 50)
