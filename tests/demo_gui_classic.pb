...
Class MainWindow Extends UI::Window
  ...
  Public Method Init()
    Super\Init("PureBasic OOP - Framework GUI (Syntaxe Standard)", #PB_Ignore, #PB_Ignore, 480, 420, #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
    UI::RegisterWindow(This\id, This)

    ; Titre
    This\*lblTitle = New UI::Label(20, 15, 440, 25, "=== Demonstration GUI PureBasic OOP (Classique) ===")
