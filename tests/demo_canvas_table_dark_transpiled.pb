...
Global *mainWin.UI_Window_vt
Global *table.UI_CanvasTable_vt
Global *lblStatus.UI_Label_vt
Global *txtFirstName.UI_TextBox_vt
Global *txtSurname.UI_TextBox_vt
Global *txtAge.UI_TextBox_vt
Global *txtSize.UI_TextBox_vt
Global *txtWeight.UI_TextBox_vt
Global *btnDarkMode.UI_CanvasButton_vt
Global *btnFilter.UI_CanvasButton_vt
...
; 4. Callbacks
; ----------------------------------------------------------------------------
Procedure OnTableSelect(*row.UI_TableRow_vt)
...
Procedure OnTableCellEdit(*row.UI_TableRow_vt, colIdx.i, newVal.s)
  If (*row And *row\GetDataContext())
    Protected *p.Person = *row\GetDataContext()
    If (*lblStatus)
...
Procedure OnTableHeaderClick(*col.UI_TableColumn_vt, order.i)
...
Procedure OnTableCheck(*row.UI_TableRow_vt, isChecked.b)
  If (*row And *row\GetDataContext())
    Protected *p.Person = *row\GetDataContext()
...
Procedure OnTableActionButton(*row.UI_TableRow_vt, buttonId.i)
  If (*row And *row\GetDataContext())
    Protected *p.Person = *row\GetDataContext()
...
Procedure OnToggleTheme(*btn.UI_CanvasButton_vt)
...
Procedure OnAddPerson(*btn.UI_CanvasButton_vt)
  AddElement(myPeople())
  ...
  Protected *newRow.UI_TableRow_vt = *table\AddRowData(@myPeople())
...
Procedure RunApp()
  ...
  *mainWin = New_UI_Window_s_i_i("Démonstrateur PureBasic OOP - UI_CanvasTable (Modern High-DPI Virtual DataGrid)", 1040, 660)
  ...
  *topBar\SetSpacing(10)
  ...
  Protected *btnAdd.UI_CanvasButton_vt = New_UI_CanvasButton_s_i_i("➕ Ajouter Ligne", 140, 34)
  *btnAdd\SetPrimaryStyle()
  *topBar\AddChild(*btnAdd)
  BindGadgetEvent(*btnAdd\GetId(), @OnAddPerson(), #PB_EventType_LeftClick)

  *btnDarkMode = New_UI_CanvasButton_s_i_i("Mode Sombre 🌙", 140, 34)
  ...
  *rootDock\AddDockChild(*topBar, #UI_Dock_Top)
  ...
  ; 2. Bottom status bar
  *lblStatus = New_UI_Label_s("Prêt. Cliquez sur un en-tête pour trier, glissez les séparateurs pour redimensionner, double-cliquez pour éditer.")
  ...
  *table\SetShowGridLines(#True)
  ...
  Protected *colActif.UI_TableColumn_vt = *table\AddColumn("Actif", 55, #UI_TableCol_CheckBox, #UI_TableAlign_Center)
  *colActif\SetGetter(@GetIsActive())
  *colActif\SetSetter(@SetIsActive())

  Protected *colIcon.UI_TableColumn_vt = *table\AddColumn("Statut", 60, #UI_TableCol_Image, #UI_TableAlign_Center)
  *colIcon\SetGetter(@GetIcon())

  Protected *colFN.UI_TableColumn_vt = *table\AddColumn("Prénom", 130, #UI_TableCol_Text, #UI_TableAlign_Left)
  *colFN\SetGetter(@GetFirstName())
  *colFN\SetSetter(@SetFirstName())

  Protected *colSN.UI_TableColumn_vt = *table\AddColumn("Nom", 130, #UI_TableCol_Text, #UI_TableAlign_Left)
  *colSN\SetGetter(@GetSurname())
  *colSN\SetSetter(@SetSurname())

  Protected *colAge.UI_TableColumn_vt = *table\AddColumn("Âge", 75, #UI_TableCol_Number, #UI_TableAlign_Right)
  *colAge\SetDecimals(0)
  *colAge\SetGetter(@GetAge())
  *colAge\SetSetter(@SetAge())

  Protected *colSize.UI_TableColumn_vt = *table\AddColumn("Taille", 85, #UI_TableCol_Float, #UI_TableAlign_Right)
  *colSize\SetDecimals(2)
  *colSize\SetGetter(@GetSize())
  *colSize\SetSetter(@SetSize())

  Protected *colWeight.UI_TableColumn_vt = *table\AddColumn("Poids (kg)", 95, #UI_TableCol_Double, #UI_TableAlign_Right)
  *colWeight\SetDecimals(2)
  *colWeight\SetGetter(@GetWeight())
  *colWeight\SetSetter(@SetWeight())

  ; Column with action buttons
  Protected *colAction.UI_TableColumn_vt = *table\AddColumn("Actions", 80, #UI_TableCol_ActionButtons, #UI_TableAlign_Center)
