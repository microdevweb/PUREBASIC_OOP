...
Interface UI_Window_vt Extends UI_Component_vt
  ...
  LoadView_s.b(xmlPath.s)
  LoadView_s_p.b(xmlPath.s, *dataContext_p)
  LoadViewFromString_s.b(xmlContent.s)
  LoadViewFromString_s_p.b(xmlContent.s, *dataContext_p)
  Close()
  Free()
  OnClose.b()
...
Declare OnTreeSelect(*node.UI_TreeNode_vt)
Declare OnTreeExpand(*node.UI_TreeNode_vt, isExpanded.b)
Declare OnTreeCheck(*node.UI_TreeNode_vt, isChecked.b)
Declare OnTreeActionBtn(*node.UI_TreeNode_vt, buttonId.i)
Global *mainWin.UI_Window_vt
Global *tree.UI_CanvasTree_vt
...
Declare.b UI_Window_LoadView_s(*This.UI_Window_Inst, xmlPath.s)
Declare.b UI_Window_LoadView_s_p(*This.UI_Window_Inst, xmlPath.s, *dataContext_p)
Declare.b UI_Window_LoadViewFromString_s(*This.UI_Window_Inst, xmlContent.s)
Declare.b UI_Window_LoadViewFromString_s_p(*This.UI_Window_Inst, xmlContent.s, *dataContext_p)
...
Procedure.b UI_Window_LoadView_s(*This.UI_Window_Inst, xmlPath.s)
  Protected *This_vt.UI_Window_vt = *This
...
Procedure.b UI_Window_LoadView_s_p(*This.UI_Window_Inst, xmlPath.s, *dataContext_p)
  Protected *This_vt.UI_Window_vt = *This
  If (*dataContext_p)
...
Procedure.b UI_Window_LoadViewFromString_s(*This.UI_Window_Inst, xmlContent.s)
  Protected *This_vt.UI_Window_vt = *This
        Protected *loader.UI_XMLLoader_vt = New_UI_XMLLoader()
        Protected res.b = #False
  If (*loader)
...
Procedure.b UI_Window_LoadViewFromString_s_p(*This.UI_Window_Inst, xmlContent.s, *dataContext_p)
  Protected *This_vt.UI_Window_vt = *This
  If (*dataContext_p)
          *This_vt\SetDataContext(*dataContext_p)
  EndIf
...
Procedure UI_CanvasTextBox_EnsureCursorVisible(*This.UI_CanvasTextBox_Inst, availW_p.i)
  Protected *This_vt.UI_CanvasTextBox_vt = *This
        Protected dText.s = *This_vt\GetDisplayText()
        Protected curPixX.i = 0
  If (StartDrawing(CanvasOutput(*This\id)))
          If (*This\fontID) : DrawingFont(*This\fontID) : EndIf
          curPixX = TextWidth(Left(dText, *This\cursorPos))
          StopDrawing()
  EndIf
...
DataSection
  UI_Window_VTable_Data:
    ...
    Data.i @UI_Window_LoadView_s()
    Data.i @UI_Window_LoadView_s_p()
    Data.i @UI_Window_LoadViewFromString_s()
    Data.i @UI_Window_LoadViewFromString_s_p()
...
; Interactive Demonstration of the new UI_CanvasTree Control
...
Procedure OnTreeSelect(*node.UI_TreeNode_vt)
...
Procedure OnTreeExpand(*node.UI_TreeNode_vt, isExpanded.b)
  If (*node And *lblStatus)
...
Procedure OnTreeCheck(*node.UI_TreeNode_vt, isChecked.b)
  If (*node And *lblStatus)
...
Procedure OnTreeActionBtn(*node.UI_TreeNode_vt, buttonId.i)
  If (*node And *lblStatus)
...
Procedure RunApp()
  ...
  *mainWin = New_UI_Window_s_i_i("Démonstration PureBasic OOP - UI_CanvasTree (DPI-Aware)", 960, 600)
  ...
  *lblStatus = New_UI_Label_s("Prêt. Cliquez sur un nœud, un chevron ou une case à cocher.")
  ...
  *tree = New_UI_CanvasTree_i_i(340, 500)
  ...
  *tree\SetOnButtonClick(@OnTreeActionBtn())
  ...
  Protected *rootItem.UI_TreeNode_vt = *tree\GetRoot()

  ; Branche Projet
  Protected *nodeProject.UI_TreeNode_vt = *tree\AddNode(*rootItem, "Mon Projet PureBasic", 0, "project")
  *nodeProject\AddButton(1, 0, 0, "Paramètres", "btn_settings")
  *nodeProject\SetExpanded(#True)

  ; Sous-branche Sources
  Protected *nodeSrc.UI_TreeNode_vt = *tree\AddNode(*nodeProject, "Sources (.pb / .pbi)", 0, "folder_src")
  ...
  *tree\AddNode(*nodeSrc, "Utilities.pbi", 0, "file_util")
  ...
  Protected *nodeFw.UI_TreeNode_vt = *tree\AddNode(*nodeProject, "Framework UI", 0, "folder_fw")
  *nodeFw\SetExpanded(#True)
  *nodeFw\AddButton(2, 0, 0, "Ouvrir dossier", "btn_open")
  
  Protected *nodeControls.UI_TreeNode_vt = *tree\AddNode(*nodeFw, "controls", 0, "folder_controls")
  ...
  *tree\AddNode(*nodeControls, "TreeView.pbi", 0, "file_native_tree")
  ...
  Protected *nodeLayouts.UI_TreeNode_vt = *tree\AddNode(*nodeFw, "layout", 0, "folder_layout")
  ...
  *tree\AddNode(*nodeLayouts, "StackPanel.pbi", 0, "file_stack")
  ...
  Protected *nodeDocs.UI_TreeNode_vt = *tree\AddNode(*rootItem, "Documentation & Guides", 0, "folder_docs")
  ...
  *tree\AddNode(*nodeDocs, "Changelog_v1.3.md", 0, "doc_log")
  ...
  ; Branche Tests
  Protected *nodeTests.UI_TreeNode_vt = *tree\AddNode(*rootItem, "Tests Unitaires", 0, "folder_tests")
  ...
  *rootDock\AddDockChild(*tree, #UI_Dock_Left)
  ...
  Protected *rightPanel.UI_Layouts_StackPanel_vt = New_UI_Layouts_StackPanel_void()
  *rightPanel\SetOrientation(#UI_Orientation_Vertical)
  *rightPanel\SetMargin(10, 10, 10, 10)

  Protected *lblTitle.UI_Label_vt = New_UI_Label_s("Contrôle UI_CanvasTree")
  *lblTitle\SetMargin(0, 0, 0, 12)
  *rightPanel\AddChild(*lblTitle)

  Protected *lblDesc.UI_Label_vt = New_UI_Label_s("Arbre virtuel haute performance dans un CanvasGadget unique avec support High-DPI natif, chevrons vectoriels anti-aliasés, cases à cocher, boutons d'action par nœud et navigation clavier (flèches, Espace).")
  *lblDesc\SetMargin(0, 0, 0, 15)
  *rightPanel\AddChild(*lblDesc)

  Protected *btnExpandAll.UI_Button_vt = New_UI_Button_s("Déplier Tout l'Arbre")
  *btnExpandAll\SetMargin(0, 0, 0, 8)
  *rightPanel\AddChild(*btnExpandAll)

  Protected *btnCollapseAll.UI_Button_vt = New_UI_Button_s("Replier Tout l'Arbre")
  *btnCollapseAll\SetMargin(0, 0, 0, 8)
  *rightPanel\AddChild(*btnCollapseAll)

  Protected *btnToggleChecks.UI_Button_vt = New_UI_Button_s("Basculer Cases à Cocher")
  *btnToggleChecks\SetMargin(0, 0, 0, 8)
  *rightPanel\AddChild(*btnToggleChecks)

  Protected *btnToggleLines.UI_Button_vt = New_UI_Button_s("Basculer Lignes d'Arborescence")
  *btnToggleLines\SetMargin(0, 0, 0, 8)
  *rightPanel\AddChild(*btnToggleLines)

  Protected *btnToggleDark.UI_Button_vt = New_UI_Button_s("Basculer Mode Sombre / Clair")
