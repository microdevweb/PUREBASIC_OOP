...
Namespace UI::MVVM {
  ...
  Class StringProperty {
    Protected *owner.UI::MVVM::ObservableObject
    Protected name.s

    Public Method Init(*ownerObj.UI::MVVM::ObservableObject, propName.s, initialVal.s = "") {
      This\*owner = *ownerObj
      This\name = propName
      If (This\*owner) {
  ...
  Class IntProperty {
    ...
    Public Method Init(*ownerObj.UI::MVVM::ObservableObject, propName.s, initialVal.i = 0) {
      This\*owner = *ownerObj
      This\name = propName
      If (This\*owner) {
  ...
  Class BoolProperty {
    ...
    Public Method Init(*ownerObj.UI::MVVM::ObservableObject, propName.s, initialVal.b = #False) {
      This\*owner = *ownerObj
      This\name = propName
      If (This\*owner) {
  ...
  Class DoubleProperty {
    ...
    Public Method Init(*ownerObj.UI::MVVM::ObservableObject, propName.s, initialVal.d = 0.0) {
      This\*owner = *ownerObj
      This\name = propName
      If (This\*owner) {
