...
Interface TestWindow_vt Extends UI_Window_vt
EndInterface
...
Structure TestWindow_Inst Extends UI_Window_Inst
  *btn.UI_Button_vt
EndStructure
...
Declare TestWindow_Init(*This.TestWindow_Inst)
...
Declare.i New_TestWindow()
Declare Free_TestWindow(*obj.TestWindow_Inst)
...
Procedure TestWindow_Init(*This.TestWindow_Inst)
  Protected *This_vt.TestWindow_vt = *This
      UI_Window_Init_s(*This, "Ma Fenetre")
      *This\btn = New_UI_Button_s("Mon Bouton")
EndProcedure
...
Procedure.i New_TestWindow()
  Protected *obj.TestWindow_Inst = AllocateStructure(TestWindow_Inst)
  If *obj
    *obj\VTable = ?TestWindow_VTable_Data
    TestWindow_Init(*obj)
  EndIf
  ProcedureReturn *obj
EndProcedure

Procedure Free_TestWindow(*obj.TestWindow_Inst)
  If *obj
    UI_Window_Free(*obj)
    FreeStructure(*obj)
  EndIf
...
Define *win.TestWindow_vt = New_TestWindow()
