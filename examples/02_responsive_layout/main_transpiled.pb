...
; 2. Main Window
Define *win.UI_Window_vt = New_UI_Window_s_i_i("PureBasic OOP - Responsive WPF Layout Demo", 900, 600)
...
Define *mainGrid.UI_Layouts_Grid_vt = New_UI_Layouts_Grid_void()
...
Define *mainEditor.UI_TextBox_vt = New_UI_TextBox_i_i_i_i_s(0, 0, 100, 100, "Zone principale de travail / Éditeur...")
*mainGrid\SetCell(*mainEditor, 1, 0)

Define *propEditor.UI_TextBox_vt = New_UI_TextBox_i_i_i_i_s(0, 0, 100, 100, "Propriétés sélectionnées...")
