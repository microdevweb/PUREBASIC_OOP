...
Interface TodoApp_TaskViewModel_vt Extends MVVM_ViewModelBase_vt
EndInterface

Interface TodoApp_MainWindow_vt Extends UI_Window_vt
EndInterface
...
Structure TodoApp_TaskViewModel_Inst Extends MVVM_ViewModelBase_Inst
  *TaskTitle.MVVM_StringProperty_vt
  *TaskCount.MVVM_IntProperty_vt
  *StatusMessage.MVVM_StringProperty_vt
  *TaskListContent.MVVM_StringProperty_vt
EndStructure

Structure TodoApp_MainWindow_Inst Extends UI_Window_Inst
EndStructure
...
Declare TodoApp_TaskViewModel_Init(*This.TodoApp_TaskViewModel_Inst)
Declare.b TodoApp_TaskViewModel_OnCommand(*This.TodoApp_TaskViewModel_Inst, cmdName.s, *param)
Declare TodoApp_MainWindow_Init(*This.TodoApp_MainWindow_Inst, *vm.TodoApp_TaskViewModel_vt)
...
Declare.i New_TodoApp_TaskViewModel()
Declare Free_TodoApp_TaskViewModel(*obj.TodoApp_TaskViewModel_Inst)
Declare.i New_TodoApp_MainWindow(*vm.TodoApp_TaskViewModel_vt)
Declare Free_TodoApp_MainWindow(*obj.TodoApp_MainWindow_Inst)
...
Procedure TodoApp_TaskViewModel_Init(*This.TodoApp_TaskViewModel_Inst)
  Protected *This_vt.TodoApp_TaskViewModel_vt = *This
        MVVM_ViewModelBase_Init(*This)
        
        ; Enregistrement des propriétés observables dans le registre MVVM
        *This\TaskTitle       = *This_vt\BindString(#PROP_TASK_TITLE, "")
        *This\TaskCount       = *This_vt\BindInt(#PROP_TASK_COUNT, 0)
        *This\StatusMessage   = *This_vt\BindString(#PROP_STATUS_MSG, "Prêt - Aucune tâche enregistrée.")
        *This\TaskListContent = *This_vt\BindString(#PROP_LIST_CONTENT, "")
EndProcedure

Procedure.b TodoApp_TaskViewModel_OnCommand(*This.TodoApp_TaskViewModel_Inst, cmdName.s, *param)
  Protected *This_vt.TodoApp_TaskViewModel_vt = *This
        Select cmdName
          Case #CMD_ADD_TASK
...
Procedure TodoApp_MainWindow_Init(*This.TodoApp_MainWindow_Inst, *vm.TodoApp_TaskViewModel_vt)
  Protected *This_vt.TodoApp_MainWindow_vt = *This
        ...
        *This_vt\LoadViewFromString(xml, *vm)
EndProcedure
...
DataSection
  ...
  TodoApp_TaskViewModel_VTable_Data:
    Data.i @MVVM_ViewModelBase_Free()
    Data.i @MVVM_ObservableObject_RegisterObserver()
    Data.i @MVVM_ObservableObject_UnregisterObserver()
    Data.i @MVVM_ObservableObject_NotifyPropertyChanged()
    ...
    Data.i @MVVM_ViewModelBase_RegisterBool()
    Data.i @MVVM_ViewModelBase_RegisterDouble()
    Data.i @TodoApp_TaskViewModel_OnCommand()
  TodoApp_MainWindow_VTable_Data:
    Data.i @UI_Window_SetDataContext()
    Data.i @UI_Window_GetDataContext()
    Data.i @UI_Component_GetID()
    Data.i @UI_Component_GetHandle()
...
Procedure.i New_TodoApp_TaskViewModel()
  Protected *obj.TodoApp_TaskViewModel_Inst = AllocateStructure(TodoApp_TaskViewModel_Inst)
  If *obj
    *obj\VTable = ?TodoApp_TaskViewModel_VTable_Data
    TodoApp_TaskViewModel_Init(*obj)
  EndIf
  ProcedureReturn *obj
EndProcedure

Procedure Free_TodoApp_TaskViewModel(*obj.TodoApp_TaskViewModel_Inst)
  If *obj
    MVVM_ViewModelBase_Free(*obj)
    FreeStructure(*obj)
  EndIf
...
Procedure.i New_TodoApp_MainWindow(*vm.TodoApp_TaskViewModel_vt)
  Protected *obj.TodoApp_MainWindow_Inst = AllocateStructure(TodoApp_MainWindow_Inst)
  If *obj
    *obj\VTable = ?TodoApp_MainWindow_VTable_Data
    TodoApp_MainWindow_Init(*obj, *vm)
  EndIf
  ProcedureReturn *obj
EndProcedure

Procedure Free_TodoApp_MainWindow(*obj.TodoApp_MainWindow_Inst)
  If *obj
    UI_Window_Free(*obj)
    FreeStructure(*obj)
  EndIf
...
Define *app.UI_Application_vt = New_UI_Application_s("TodoApp MVVM")

; 3. Instanciation du ViewModel (État réactif et logique métier)
Define *vm.TodoApp_TaskViewModel_vt = New_TodoApp_TaskViewModel()

; 4. Instanciation de la Vue (Injection du ViewModel en DataContext)
Define *mainWindow.TodoApp_MainWindow_vt = New_TodoApp_MainWindow(*vm)
